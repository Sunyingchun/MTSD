...
class yolov3SPP(nn.Module):
    ...
    def __init__(self, 
        ...
        # concat+1*1 conv
        self.concatConv = conv2DBatchNorm(2048, 1024,  k_size=1, stride=1,
                                                  padding=0)
        # Final conv layers
        self.cbr_final = conv2DBatchNormRelu(1024, 512, k_size=3, stride=1, 
                                                  padding=1, bias=False, leaky_relu=True)
    ...
    def forward(self, x, labels=None, segMaps=None):
        ...
        convfinal = self.conv27_2(self.conv27_1(conv4))
        ##################PSP#########################
        pda = self.pyramid_pooling(convfinal)
        ...
        feat3 = self.conv38(self.conv6(cat2))
...
if __name__ == '__main__':
    ...
    yolov3SPP = yolov3SPP(version='cityscapes')
